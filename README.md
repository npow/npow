...
🍁 **ML Engineer @ Netflix** · **Waterloo & McGill alum**
...
- 📏 **[skill-bench](https://github.com/npow/skill-bench)** — A/B test your Claude Code skills with statistical rigor
...
- 🔮 **[predictle](https://github.com/npow/predictle)** — Endless Wordle-style game: rank live Manifold prediction markets by probability.
...
- 🏭 **[brass-birmingham](https://github.com/npow/brass-birmingham)** — Full-fidelity digital adaptation with hotseat multiplayer and era-accurate gameplay.
- 🍔 **[food-chain-magnate](https://github.com/npow/food-chain-magnate)** — Browser adaptation with complete rules, milestones, and procedural maps.
- 🌌 **[galactic-uprising](https://github.com/npow/galactic-uprising)** — Asymmetric rebellion-vs-empire strategy with hidden-base pressure and AI opponent.
